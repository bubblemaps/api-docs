...
- The token chain and address, through path parameters. If you provide a non-public chain, you'll get a `400` error (see [Get Supported Chains](/data/api/endpoints/get-supported-chains)).
